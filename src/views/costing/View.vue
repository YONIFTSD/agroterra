              ...
              <b-row>
                ...
                <b-col md="3">
                  <b-form-group label="Método de Prorrateo :">
                    <b-form-select disabled ref="proration_type" v-model="shopping.proration_type" :options="proration_type"></b-form-select>
                  </b-form-group>
                </b-col>
                  ...
                  <div class="col-md-12">
                    <div class="table-responsive mt-3">
                      <table  class="table  table-bordered table-hover table-lg mt-lg mb-0">
                        ...
                        <tbody v-for="(item, it) in shopping.shopping_detail" :key="item.id_product">
                          <tr>
                     ...
                     <b-col md="12">
                       <div class="table-responsive mt-3">
                        <table  class="table  table-bordered table-hover table-lg mt-lg mb-0">
                          ...
                          <tbody v-for="(item, it) in shopping.linkages_cost" :key="it">
                            <tr>
                ...
                <b-col md="2">
                  <b-form-group  label="" class="text-right m-0">
                    <b-form-input class="text-right" type="number" step="any" readonly v-model="shopping.invoice_expenses"></b-form-input>
                  </b-form-group>
                  <b-form-group  label="" class="text-right m-0">
                    <b-form-input class="text-right" type="number" step="any" readonly v-model="shopping.taxed_operation_final"></b-form-input>
                  </b-form-group>
                  <b-form-group label="" class="text-right m-0">
                    <b-form-input class="text-right" type="number" step="any" readonly v-model="shopping.exonerated_operation_final"></b-form-input>
                  </b-form-group>
                  <b-form-group  label="" class="text-right m-0">
                    <b-form-input class="text-right" type="number" step="any" readonly v-model="shopping.unaffected_operation_final"></b-form-input>
                  </b-form-group>
                  <b-form-group  label="" class="text-right m-0">
                    <b-form-input class="text-right" type="number" step="any" readonly v-model="shopping.discount_final"></b-form-input>
                  </b-form-group>
                  <b-form-group label="" class="text-right m-0">
                    <b-form-input class="text-right" type="number" step="any" readonly v-model="shopping.igv_final"></b-form-input>
                  </b-form-group>
                  <b-form-group label="" class="text-right m-0">
                    <b-form-input class="text-right" type="number" step="any" readonly v-model="shopping.total_final"></b-form-input>
  ...
  axios({
    ...
    .then(function (response) {
      if (response.data.status == 200) {
          ...
          me.shopping.amount_note = response.data.result.shopping.amount_note;
          me.shopping.invoice_expenses = response.data.result.shopping.invoice_expenses;
          me.shopping.taxed_operation_final = response.data.result.shopping.taxed_operation_final;
          me.shopping.exonerated_operation_final = response.data.result.shopping.exonerated_operation_final;
          me.shopping.unaffected_operation_final = response.data.result.shopping.unaffected_operation_final;
          me.shopping.discount_final = response.data.result.shopping.discount_final;
          me.shopping.subtotal_final = response.data.result.shopping.subtotal_final;
          me.shopping.igv_final = response.data.result.shopping.igv_final;
          me.shopping.total_final = response.data.result.shopping.total_final;
