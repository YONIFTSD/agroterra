              ...
              <b-row>
                ...
                <b-col md="3">
                  <b-form-group label="Almacen :">
                    <b-form-select ref="id_warehouse" v-model="shopping.id_warehouse" :options="warehouse"></b-form-select>
                ...
                <b-col md="8"></b-col>
                <b-col md="4">
                  <b-form-group  label-cols-sm="7" label="Gastos :" class="text-right m-0">
...
export default {
  ...
  methods: {
    ...
    ...mapActions('Shopping',['mLoadResetShoppingDetail','mLoadUnitValue','mLoadExpensesValue','mLoadTotalsShoppingDetail']),
    
  },

  computed: {
    ...mapState('Shopping',['shopping_detail','total_shopping','munit_value']),
    ...mapState(["url_base"]),
    token: function () {
