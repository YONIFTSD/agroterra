<template>
  <div>
    <b-modal size="xl" hide-footer v-model="modalProducts" class="w-100" title="Productos Transformables">
      <b-row>
        <b-col md="12">
            ...
            <table class="table table-hover table-bordered">
              <thead>
                <tr>
                  ...
                  <th width="7%"  rowspan="2" class="text-center align-middle">Cantidad</th>
                  <th width="8%"  rowspan="2" class="text-center align-middle">Capacidad</th>
...
export default {
  ...
  methods: {
      ...
      ListWarehouse,
        ...
        ...mapActions('Transform',['mLoadAddTransformOutputDetail']),
...
function AddProduct(id_product) {
    ...
    .then(function (response) {
      if (response.data.status == 200) {
        ...
        me.mLoadAddTransformOutputDetail(detail);
...
function SearchProducts() {
  ...
  let url = this.url_base + "search-products-transforms/"+this.id_establishment+"/"+"1"+"/"+ search;
