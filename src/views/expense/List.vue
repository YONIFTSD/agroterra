            ...
            <b-row>
              <b-col sm="12" md="5">
                  <b-form-group>
                    ...
                    <v-select @input="ListExpenses" placeholder="Todos" class="w-100" :filterable="false" label="name" v-model="provider" @search="SearchProvider" :options="providers"></v-select>
                  </b-form-group>
                </b-col>

                <b-col sm="12" md="2">
                  <b-form-group label="Desde :">
                    <b-form-input @change="ListExpenses" class="text-center" :max="to" type="date"  ref="to" v-model="from"></b-form-input>
                ...
                <b-col sm="12" md="2">
                  <b-form-group label="Hasta :">
                    <b-form-input @change="ListExpenses" class="text-center" :min="from" type="date"  ref="from" v-model="to"></b-form-input>
                ...
                <b-col sm="6" md="2">
                  <b-form-group label=".">
                    ...
                    <b-input-group-append>
                      <b-button variant="primary" @click="ListExpenses"><b-icon icon="search"></b-icon></b-button>
                    </b-input-group-append>
                  </b-input-group>
                  </b-form-group>
                </b-col>
                ...
                <b-col sm="6" md="1">
                  <b-form-group label=".">
                    <b-link  v-if="Permission('ExpenseAdd')" class="btn form-control btn-primary"  :to="{ path: '/egresos/nuevo' }" append ><i class="fas fa-file"></i></b-link>
                  </b-form-group>
                </b-col>
            </b-row>
...
function ListExpenses() {
  ...
  let me = this;
  let url = this.url_base + "expense/list/" + id_provider + "/" + this.from + "/" + this.to + "/" + this.id_establishment + "/" + search + "?page=" + this.currentPage;
