  ...
  <div>
    <CRow>
      <CCol col>
        <CCard>
          <CCardHeader>
            <strong> Modulo Nota de Crédito/Débito - Editar</strong>
          </CCardHeader>
          <CCardBody>
              ...
              <b-row>
                ...
                <b-col md="6">
                  <b-form-group label="Proveedor:">
                    <b-form-input readonly  v-model="credit_debit.provider"></b-form-input>
  ...
  axios({
    ...
    .then(function (response) {
      if (response.data.status == 200) {
          ...
          let credit_debit_note_detail =  response.data.result.credit_debit_note_detail;
          for (let index = 0; index < credit_debit_note_detail.length; index++) {
          const element = credit_debit_note_detail[index];
          let detail = {
