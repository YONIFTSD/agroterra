  ...
  <div>
    <CRow>
      <CCol col>
        <CCard>
          <CCardHeader>
            <strong> Modulo Comprobante - Ver</strong>
          </CCardHeader>
          <CCardBody>
            <b-form id="Form">
              <b-row>
                ...
                <b-col md="4">
                  <b-form-group>
                    ...
                    <b-form-input class="text-center" disabled :value="CodeInvoice(payment.voucher_type) + ' '+payment.serie  + ' - '+ payment.number"></b-form-input>
                  </b-form-group>
                </b-col>
                ...
                <b-col md="3">
                  <b-form-group>
                    ...
                    <b-form-input class="text-center" disabled v-model="payment.broadcast_date" type="date"></b-form-input>
                  </b-form-group>
                </b-col>
                ...
                <b-col md="3">
                  <b-form-group>
                    ...
                    <b-form-select v-model="payment.way_to_pay" disabled :options="way_to_pay"></b-form-select>
                ...
                <b-col md="2">
                  <b-form-group>
                    ...
                    <b-form-select v-model="payment.coin" disabled :options="coins"></b-form-select>
                 ...
                 <b-col md="5">
                  <b-form-group>
                    ...
                    <input class="form-control" disabled :value="payment.client" />
                  </b-form-group>
                </b-col>
                ...
                <b-col md="7">
                  <b-form-group>
                    ...
                    <b-form-input disabled v-model="payment.observation" type="text"></b-form-input>                    
                  </b-form-group>
                </b-col>
...
<!-- {{room_control_detail}} -->
                ...
                <b-col md="4">
                  ...
                  <b-form-group label-cols-sm="6"  label="Ope. Gravadas :" class="text-right">
                    <b-form-input type="number" step="any" class="text-right" disabled v-model="payment.taxed_operation" ></b-form-input>
                  </b-form-group>

                  <b-form-group label-cols-sm="6"  label="Ope. Inafectas :" class="text-right">
                    <b-form-input type="number" step="any" class="text-right" disabled v-model="payment.exonerated_operation" ></b-form-input>
                  </b-form-group>

                  <b-form-group label-cols-sm="6"  label="Ope. Exoneradas :" class="text-right">
                    <b-form-input type="number" step="any" class="text-right" disabled v-model="payment.unaffected_operation" ></b-form-input>
                  </b-form-group>
                ...
                <b-col md="4">
                  ...
                  <b-form-group label-cols-sm="6"  label="Subtotal :" class="text-right">
                    <b-form-input type="number" step="any" class="text-right" disabled v-model="payment.subtotal" ></b-form-input>
                  </b-form-group>

                  <b-form-group label-cols-sm="6"  label="Igv (18%) :" class="text-right">
                    <b-form-input type="number" step="any" class="text-right" disabled v-model="payment.igv" ></b-form-input>
                  </b-form-group>

                  <b-form-group label-cols-sm="6"  label="Total :" class="text-right">
                    <b-form-input type="number" step="any" class="text-right" disabled v-model="payment.total" ></b-form-input>
                  </b-form-group>
                ...
                <b-col md="3"></b-col>
                <b-col md="3">
                  <button class="btn form-control btn-warning" @click="PrintPdf">IMPRIMIR</button>
                </b-col>
                <b-col md="3">
                  <b-link  class="btn form-control btn-primary" :to="{ path: '/pago/listar' }" append >REGRESAR</b-link>
                </b-col>
