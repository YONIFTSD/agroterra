        ...
        <CCard>
          ...
          <CCardBody>
            <b-row>
              ...
              <b-col sm="6" md="2">
                <b-link v-if="Permission('CategoryAdd')" class="btn form-control btn-primary" :to="{ path: '/categoria/nuevo' }" append >NUEVO</b-link >
              </b-col>
              <b-col sm="6" md="2">
                <b-input-group>
...
function ListCategory() {
  ...
  let me = this;
  let url = this.url_base + "category/list/" + search + "?page=" + this.currentPage;
