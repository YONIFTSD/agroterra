  ...
  <div>
    <CRow>
      <CCol col>
        <CCard>
          <CCardHeader>
            <strong> Modulo Arqueo de Caja - Ver</strong>
          </CCardHeader>
          <CCardBody>
                                ...
                                <tbody>
                                    <tr class="bg-success">
                                          ...
                                          <tr class="bg-light text-dark">
                                            ...
                                            <td class="text-right" >{{cash.account_deposit_pen}}</td>
                                            <td class="text-right" >{{cash.account_deposit_usd}}</td>
                                            <td class="text-right" >{{cash.account_deposit_clp}}</td>
                                          </tr>
                                          <tr class="bg-info">
...
function Editcash() {
  ...
  this.newcash.id_user = this.user.id_user;

  let me = this;
  let url = this.url_base + "cash/add";
  let data = this.newcash;
