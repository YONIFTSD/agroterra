  ...
  <div>
    <CRow>
      <CCol col>
        <CCard>
          <CCardHeader>
            <strong> Modulo de Kardex - Valorado</strong>
          </CCardHeader>
          <CCardBody>
            ...
            <div class="table-responsive mt-3">
              <table class="table table-hover table-bordered">
                <thead>
                  <tr>
                    <th class="text-center" colspan="4">Documento de traslado, comprobante de pago, documento interno o similir</th>
                    ...
                    <th class="text-center" colspan="3">S. Final.</th>
                ...
                <tbody v-for="(item, it) in kardex_valued" :key="it">
                  <tr>
                    ...
                    <td class="text-right">{{ item.input_unit_price }}</td>
                    <td class="text-right">{{ item.input_total_price }}</td>
                    <td class="text-right">{{ item.output }}</td>
                    <td class="text-right">{{ item.output_unit_price }}</td>
                    <td class="text-right">{{ item.output_total_price }}</td>
                    <td class="text-right">{{ item.balance }}</td>
                    <td class="text-right">{{ item.balance_unit_price }}</td>
                    <td class="text-right">{{ item.balance_total_price }}</td>
