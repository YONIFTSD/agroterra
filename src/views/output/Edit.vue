              ...
              <b-row>
                ...
                <b-col md="6">
                  <b-form-group label="Proveedor :">
                   <b-form-input type="text" disabled :value="output.provider"></b-form-input>
                  </b-form-group>
                </b-col>
                ...
                <b-col md="3">
                  <b-form-group label="Fecha Emision:">
                    <b-form-input type="date" ref="broadcast_date" v-model="output.broadcast_date"></b-form-input>
  ...
  axios({
    ...
    .then(function (response) {
      if (response.data.status == 200) {
        ...
        for (let index = 0; index < response.data.result.output_detail.length; index++) {
          const element = response.data.result.output_detail[index];
          me.mLoadAddOutputDetail(element);
