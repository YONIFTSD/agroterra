                  ...
                  <b-row>
                    ...
                    <b-col md="12">
                      <b-form-group label="Nombre:">
                        <b-form-input disabled type="text" ref="name" v-model="product.name" ></b-form-input>
                    ...
                    <b-col md="4">
                      <b-form-group label="Presentación :">
                        <b-form-input disabled type="text" ref="presentation" v-model="product.presentation" ></b-form-input>
                    ...
                    <b-col md="12">
                      <b-form-group label="Descripción:">
                        <b-form-textarea disabled ref="description"  v-model="product.description"></b-form-textarea>
                      </b-form-group>
                    </b-col>
                    ...
                    <b-col md="3">
                      <b-form-group label="IGV :">
                        <select disabled ref="igv" v-model="product.igv" class="form-control">
