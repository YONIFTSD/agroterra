        ...
        <CCard>
          ...
          <CCardBody>
            <b-row>
              ...
              <b-col sm="6" md="2">
                <b-link
                  v-if="Permission('CoverPageAdd')"
                  class="btn form-control btn-primary"
                  :to="{ path: '/portadas/nuevo' }"
                  append
                  >NUEVO</b-link
                >
              </b-col>
            ...
            <div class="table-responsive mt-3 height-table">
              <table class="table table-hover table-bordered">
                ...
                <tbody v-for="(item, it) in data_table" :key="item.id_cover_page">
                  <tr>
                    ...
                    <td class="text-center">
                      <b-dropdown bloque size="sm" text="Acciones" right>
                        <b-dropdown-item
                          v-if="Permission('CoverPageEdit')"
                          @click="EditCoverPage(item.id_cover_page)"
                          >Editar</b-dropdown-item
                        >
                        <b-dropdown-item
                          v-if="Permission('CoverPageView')"
                          @click="ViewCoverPage(item.id_cover_page)"
                          >Ver</b-dropdown-item
                        >
                        <b-dropdown-item
                          v-if="Permission('CoverPageDelete')"
                          @click="ConfirmDeleteCoverPage(item.id_cover_page)"
