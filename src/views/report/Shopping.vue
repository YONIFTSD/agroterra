          ...
          <b-form id="Form" autocomplete="off" @submit.prevent="Validate">
            ...
            <div class="table-responsive mt-3">
              <table class="table table-hover table-bordered">
                <thead>
                  <tr>
                    <th class="text-center" colspan="13">COMPRAS ( {{report.from}} -  {{report.to}}) </th>
                  </tr>
                  <tr>
                    ...
                    <th class="text-center">Ope. Gravadas</th>
                    <th class="text-center">Ope. Exoneradas</th>
                    <th class="text-center">Ope. Inafectas</th>
...
function Report(me) {
  me.report.id_provider = me.provider == null ? 'all':me.provider.id;
  let data = me.report;
  let url = this.url_base + "report/shopping";
  me.isLoading = true;
  axios({
    method: "POST",
    url: url,
